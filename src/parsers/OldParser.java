...
public class OldParser {
    ...
    protected OldParserStrategy parserStrategy;
    protected String fileName;
    protected String outputFileName;

    public OldParser(String fileName, OldParserStrategy parserStrategy, String outputFileName) {
     ...
     */
    public void setParserStrategy(OldParserStrategy strategy) {
